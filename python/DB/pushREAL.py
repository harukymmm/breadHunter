...
bread_records = [
    ...
    (21,"ベーコンバーガー",2,"../../python/DB/image/シズヤ/21.png","お腹一杯バーガー"),
    (22,"ホットドッグ",2,"../../python/DB/image/シズヤ/22.png","パン屋の本気のホットドッグ"),
    (23,"ふわふわメロンパン",2,"../../python/DB/image/シズヤ/23.png","柔らかいくちどけ"),
    (31,"キャベツサンド",3,"../../python/DB/image/ブリアン/31.jpeg","シャキシャキキャベツ"),
    (32,"たまごサンド",3,"../../python/DB/image/ブリアン/33.jpeg","たくさん卵"),
    (33,"プレッツェル",3,"../../python/DB/image/ブリアン/34.jpeg","たくさん卵"),
    (41,"あんパン",4,"../../python/DB/image/ルバカサブル/41.png","和の甘味がお口に広がる"),
    (42,"レーズンフランスパン",4,"../../python/DB/image/ルバカサブル/42.png","フランスパンにはレーズンだね"),
    (43,"固そうなパン",4,"../../python/DB/image/ルバカサブル/43.png","カッチカチやで"),
    (51,"抹茶ブレッド",5,"../../python/DB/image/ボロニヤ/51.png","大人の渋み"),
    (52,"チョコブレッド",5,"../../python/DB/image/ボロニヤ/52.png","子供の甘み"),
]
