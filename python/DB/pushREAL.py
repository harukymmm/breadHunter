...
#追加するレコード
bread_records = [
    (11,"あんドーナツ", 1, "../../python/DB/image/チェルキオ/11.jpeg", "あんこが入ったドーナツ"),
    (12,"プレーンフォカッチャ",1, "../../python/DB/image/チェルキオ/12.jpeg", "シンプルなフォカッチャ"),
    (13,"お豆腐メロンパン",1, "../../python/DB/image/チェルキオ/13.jpeg", "やさしい味のメロンパン"),
    (14,"レーズンパン",1,"../../python/image/チェルキオ/14.jpeg","レーズンたっぷり"),
    (15,"ベーコンエッグ",1,"../../python/image/チェルキオ/15.jpeg","ベーコンでがっつり"),
    (16,"シナモンドーナツ",1,"../../python/image/チェルキオ/16.jpeg","シナモンの香りあふれる"),
    (17,"ライ麦パンとハムチーズ",1,"../../python/image/チェルキオ/17.jpeg","ハムとチーズのナイスタッグ"),
    (18,"カプレーゼ",1,"../../python/DB/image/チェルキオ/18.jpeg","トマトさっぱり"),
    (19,"クリームパン",1,"../../python/DB/image/チェルキオ/19.jpeg","クリームの量がやばい"),
    (110,"枝豆とウインナーのパン",1,"../../python/DB/image/チェルキオ/110.jpeg","意外な組み合わせがおいしい"),
    (111,"りんごとゴルゴンゾーラのフォカッチャ",1,"../../python/DB/image/チェルキオ/111.jpeg","チーズのパンチが癖になる"),
    (21,"ベーコンバーガー",2,"../../python/DB/image/シズヤ/21.jpeg","お腹一杯バーガー"),
    (22,"ホットドッグ",2,"../../python/DB/image/シズヤ/22.jpeg","パン屋の本気のホットドッグ"),
    (23,"ふわふわメロンパン",2,"../../python/DB/image/シズヤ/23.jpeg","柔らかいくちどけ"),
    (31,"キャベツサンド",3,"../../python/DB/image/ブリアン/31.jpeg","シャキシャキキャベツ"),
    (32,"たまごサンド",3,"../../python/DB/image/ブリアン/32.jpeg","たくさん卵"),
    (33,"プレッツェル",3,"../../python/DB/image/ブリアン/32.jpeg","たくさん卵"),
    (41,"あんパン",4,"../../python/DB/image/ルバカサブル/41.jpeg","和の甘味がお口に広がる"),
    (42,"レーズンフランスパン",4,"../../python/DB/image/ルバカサブル/42.jpeg","フランスパンにはレーズンだね"),
    (43,"固そうなパン",4,"../../python/DB/image/ルバカサブル/43.jpeg","カッチカチやで"),
    (51,"抹茶ブレッド",5,"../../python/DB/image/ボロニヤ/51.jpeg","大人の渋み"),
    (52,"チョコブレッド",5,"../../python/DB/image/ボロニヤ/52.jpeg","子供の甘み"),
]
